...
@section TODO
- Seperate showing the video result into another thread beacuase it adds a large delay to the loop

@section Author(s)
- Created by Adrian Sochaniwsky on 13/11/2022
- Modified for ROS2, source code: https://github.com/mikel-brostrom/Yolov5_StrongSORT_OSNet
